...
/*
  at first index check current and next.          char array[]
  or
  check next index
    check for object ~30 cm (2 crossroads)        bool objectFront
      calc new route                              break edit char array
    go direction
      check for crossroad / keep track            int currentCrossroad
        change speed depending on next direction
        or
        continue
  else
  at object start object detection
*/
